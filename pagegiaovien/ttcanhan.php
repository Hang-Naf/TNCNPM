    ...
    <aside class="sidebar">
        ...
        <nav class="menu">
            <div class="menu-section">
                ...
                <ul>
                    <li class="active" onclick="window.location.href='../pagegiaovien/ttcanhan.php'"><i
                            class="fa-solid fa-house"></i> Thông tin cá nhân</li>
                ...
                <div class="profile">
                    <div class="profile-card">
                        <div class="profile-left">
                            ...
                            <br>
                            <b class="name"><big><?= htmlspecialchars($gv['hoVaTen']) ?></big></b>
                            <div class="sub">Bộ môn <?= htmlspecialchars($gv['boMon']) ?></div>
                        </div>

                        <div class="profile-right">
                            <p><strong>Giới thiệu chung:</strong></p>
                            <p><strong>Bằng cấp chuyên môn:</strong></p>
