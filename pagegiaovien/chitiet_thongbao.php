...
<body>
    <aside class="sidebar">
        ...
        <nav class="menu">
            ...
            <div class="menu-section">
                ...
                <ul>
                    <li class="active" onclick="window.location.href='../pagegiaovien/thongbao.php'"><i
                            class="fa-solid fa-bell"></i> Xem thông báo</li>
                </ul>
            </div>
        </nav>
    </aside>
    ...
    <div class="main-content">
        <header class="header">
            ...
            <div class="right">
                <div class="user-info" onclick="toggleUserMenu()"><i
                        class="fa-solid fa-user"></i><span><?= htmlspecialchars($gv['hoVaTen']) ?></span><i
        ...
        <div class="container">
            ...
            <label>Nội dung:</label> <?= htmlspecialchars($noiDung) ?>
            ...
            <div class="radio-group">
                ...
                <label><input type="radio" <?= (stripos($nguoiNhan, 'Giáo') !== false) ? 'checked' : '' ?> disabled> Giáo
                    viên</label>
                <label><input type="radio" <?= (stripos($nguoiNhan, 'Học') !== false) ? 'checked' : '' ?> disabled> Học
                    sinh</label>
            </div>
            ...
            <p><label>Tệp đính kèm:</label>
                <?php if (!empty($tb['tepDinhKem'])): ?>
                    <br>
                    <a class="file-link" href="../uploads/thongbao/<?= htmlspecialchars($tb['tepDinhKem']) ?>"
                        target="_blank">
