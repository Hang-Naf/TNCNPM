    ...
    <div class="main-content">
        ...
        <div class="container">
            ...
            <div class="thongbao-box"
                style="background:#fff; border-radius:10px; box-shadow:0 2px 5px rgba(0,0,0,0.1); padding:15px; margin-top:10px;">
                <table style="width:100%; border-collapse:collapse;">
                    ...
                    <tbody>
                        ...
                        <?php else: ?>
                            <tr>
                                <td colspan="2" style="padding:15px; text-align:center; color:#777;">Không có thông báo nào.
                                </td>
                            </tr>
                        <?php endif; ?>
                    </tbody>
