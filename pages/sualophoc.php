...
if ($maLop <= 0) {
    die("Mã lớp không hợp lệ");
}

// Lấy thông tin lớp học
$rs = $conn->query("SELECT * FROM lophoc WHERE maLop=$maLop");
if (!$rs || $rs->num_rows == 0) {
...
<body>
    ...
    <div class="main-content">
        ...
        <h2 style="margin-left: 30px;">SỬA LỚP HỌC</h2>
    ...
    <script>
        document.getElementById("editForm").addEventListener("submit", async e => {
            ...
            if (json.message) window.location.href = "qllophoc.php";
        });
