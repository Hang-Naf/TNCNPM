...
<body>
    ...
    <div class="main-content">
        ...
        <div id="main-container">
            ...
            <h3>Nhập điểm với file excel</h3>
            <input type="file" style="border: none;">
            <br><br>
            <div style="display: flex; justify-content: space-between;">
                <div>
                    <button class="add-btn">File mẫu</button>
                    <button class="add-btn">Import</button>
                </div>
                <button class="btn-secondary" onclick="window.location.href = 'qldiemso.php'">Quay lại</button>
            </div>
